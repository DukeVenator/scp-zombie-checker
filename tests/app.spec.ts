...
test('export badge modal shows Exported by when agent profile is set', async ({ page }) => {
  await seedAgentProfile(page)
  await page.goto('/#/')
  await page.locator('.hero-actions').getByRole('link', { name: 'New patient' }).click()

  await page.getByLabel('Subject name').fill('Export Test')
  await continueBtn(page).click()
  await continueBtn(page).click()
  await page.locator('.step-option-btn', { hasText: 'Unknown' }).click()
  await skipBtn(page).click()
  ...
  await skipBtn(page).click()
  await skipBtn(page).click()
  await page.locator('.step-option-btn', { hasText: 'Normal' }).click()
  await page.getByRole('button', { name: /^Normal / }).click()
  await page.locator('.step-option-btn', { hasText: 'YES' }).click()
  await continueBtn(page).click()
...
test('patient with four symptoms gets Suspected status and infection above 40%', async ({ page }) => {
  ...
  await page.getByLabel('Subject name').fill('Symptom Test')
  await continueBtn(page).click()
  await continueBtn(page).click()
  await page.locator('.step-option-btn', { hasText: 'Unknown' }).click()
  await skipBtn(page).click()
